//https://www.hackerearth.com/problem/algorithm/matryoshkas/
/*
Problem
...
Note : Sample Input / Output has two test cases, but actual Input / Output will have only one test case per test file.
*/
...
int main() {
	...
	Solution solution;
	cout << "The result:" << solution.solve(sizes);
}